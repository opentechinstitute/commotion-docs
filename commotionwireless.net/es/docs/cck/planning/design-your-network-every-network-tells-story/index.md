...
<h2>Cada Red Cuenta una Historia Piezas del Juego</h2>
...
<p><strong>Bueno para: </strong>Uso en interiores, conexiones dentro de una casa o edificio</p>
...
<p><strong>Bueno para:</strong> Conexiones exteriores entre edificios</p>
...
<p><strong>Bueno para:</strong> Conexiones exteriores a través de distancias más largas y amplias</p>
...
<p><strong>Bueno para:</strong> Conexiones exteriores de rangos largos entre dos puntos específicos</p>
...
<p>1. Tu grupo debe tener de 3 a 5 jugadores que esten familiarizados con el vecindario. Reúne tus suministros.</p>

<p>2. Haz un dibujo de tu vecindario. Ya sea que dibujes los puntos emblemáticos y calles en tu vecindario en un papel largo, o recortes los elementos del módulo "Diseña tu Red: Elementos de Construcción" y los pegues. Todos en el grupo deberían contribuir.</p>

<p>3. Mientras mueves los elementos alrededor para crear tu mapa, comienza por discutir qué "historia" se está contando a través del diseño de la red. ¿Por qué es la carretera importante? ¿Qué pasa en los edificios de departamentos? ¿Quiénes son los líderes comunitarios?</p>
...
<p class="tip">Pregúntate a ti mismo y tus vecinos: ¿Qué hay de especial en su vecindario? ¿Dónde ocurren las historias?</p>

<p>4. Ahora dibuja las conexiones inalámbricas con los marcadores. Cuando estes dibujando tus conexiones, piense en las relaciones sociales que existen o que podrían construirse.</p>
...
<p>6. ¡Cuenta la Historia de Tu Red! Discute con tu grupo lo que ves en el mapa. Si estás con otros grupos, pueden presentarse sus redes unos a otros.</p>

<p><strong>Estas son algunas preguntas que te ayudarán a contar la historia:</strong></p>

<p>¿Quiénes son los personajes de tu vecindario?</p>

<p>¿Cuáles son las relaciones entre ellos?</p>

<p>¿Qué problemas del vecindario podrían ser solucionados usando una red inalámbrica?</p>

<p>Por ejemplo, ¿la red junta dos partes del vecindario que estaba separadas por un río o carretera?</p>
...
<section id="cut-out">
<h2>Recorta los routers para crear las piezas de juego</h2>
...
<dl>
	<dt>Línea de vista</dt>
	<dd>Un camino sin obstrucción para que las señales inalámbricas viajen entre edificios o dispositivos.</dd>
	<dt>Onda de radio</dt>
	<dd>Una señal eléctrica y magnética que puede moverse a través del aire u otros materiales. Puede llevar información a distancias cortas o largas. Las estaciones de radio, teléfonos celulares, transmisiones de radio, transmisiones televisivas, y el Wi-Fi todos usan ondas de radio.</dd>
	<dt>Router</dt>
	<dd>Un dispositivo que determina como los mensajes se mueven a través de una red de computadoras.</dd>
	<dt>Antena</dt>
	<dd>Convierte las señales eléctricas en ondas de radio. Está normalmente conectado a un transmisor de radio o receptor de radio, y es la interfaz entre las señales eléctricas en la radio, y el movimiento de las señales a través del aire.</dd>
	<dt>Node<o/dt>
