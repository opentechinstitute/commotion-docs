...
<h3>2. PIENSA EN QUIEN ENTREVISTARÁS</h3>
...
<p><strong>Empresa u Organización</strong></p>
...
<p>[&nbsp; ] Establecer una biblioteca digital para el vecindario p>
...
<h3>5. APLICACIÓN DE LA ENCUESTA</h3>

<p>Puedes aplicar la encuesta vía telefónica, por correo electrónico o en persona caminando alrededor de tu vecindario. A veces una combinación de estos tres métodos asegura un mayor alcance a diferentes personas con distintas opiniones, información y puntos de vista.</p>

<p> Si está encuestando por teléfono o mediante correo electrónico, asegúrete de conocer todas las calles de tu vecindario para que puedas ubicar en un mapa las construcciones donde es más probable que la gente esté interesada en el proyecto. También puede usar alguna herramienta en línea como SurveyMonkey, pero entonces es probable que no tenga alcance a la gente que no tiene acceso a internet.</p>

<p>Distribuye la encuesta con un diagrama o un volante pata que la gente tenga un mayor entendimiento de porqué se está colectando la información y como se planea usarla. Si no planeas recolectar las encuestas en el momento que las aplicas, asegúrete de dar instrucciones claras y completas de a dónde regresarlas una vez que las hayan completado.</p>
...
<p class="tip"> Tal vez quieras crear un “guión”” para presentarte a ti y al proyecto. Esto facilita la explicación de por qué está haciendo la encuesta. Por ejemplo, puede decir “Hola, mi nombre es____. Vivo en  la calle ____ y estoy interesado en comenzar una red inalámbrica comunitaria para ayudar a la gente en este vecindario  a tener acceso a Internet. ¿Le importaría si le hago algunas preguntas acerca de su experiencia con Internet y equipo en esta área?” p>
...
<h3> PASOS SIGUIIENTES: USE LOS DATOS DE LA ENCUESTA EN UN MAPA</h3>

<p> A continuación se explica cómo el encuestar puede ayudarlo cuando esté listo para instalar los routers.</p>

<p>Primero, encuentra un mapa de tu vecindario. Puedes usar un mapa actualizado en papel o uno de una plataforma en Internet como OpenStreetMap o Google Maps. Basado en tus resultados de la encuesta, pon diferentes marcadores en el mapa para: </p>

<ul>
	<li>Los edificios que piensas que son un buen punto de comienzo para la red (puertas de enlace y/o fuentes de poder disponibles, o socios potenciales)</li>
	<li> Casas/edificios de socios o aliados que encontraste mediante las encuestas </li>
</ul>

<p class="tip"> La colección de datos debe ser constante. Encuestar solo una vez al inicio del proyecto no es suficiente en la mayoría de las veces. También puedes explorar distintos métodos para recaudar información y saber cómo avanza el proyecto, como entrevistas y juntas grupales, o enfocadas a algún grupo.</p>
