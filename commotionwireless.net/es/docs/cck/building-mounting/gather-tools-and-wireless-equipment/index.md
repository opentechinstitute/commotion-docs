...
<p>Para instalación estándar, selecciona uno de los routers Ubiquiti por sitio. Agrega un router interior para extender la cobertura dentro del edificio. Estima el número de pies de cableado para conectar los routers unos con otros, y el router Ubiquiti a la fuente de energía, con dos puntas RJ-45 por cable (más un poco extra, por si se ocupa).</p>

<p class="tip">Hay dos maneras posibles de conectar este router al Internet:<br />
<br />
Si el nodo Commotion está conectado al puerto LAN del router (red interna), y hay un módem o conexión a Internet conectado en el puerto WAN, se proporcionará una conexión a Internet a la red mesh del vecindario.<br />
<br />
Si el nodo Commotion esta conectado al puerto WAN del router (Internet), la conexión al Internet se proveerá a la red mesh del vecindario. Esto requiere que tus vecinos donen una o más conexiones al enmallado. Si no hay conexión al Internet, puedes usar la red como una "Intranet" o red local.</p>
