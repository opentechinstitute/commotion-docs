...
<table>
 <tr>
 <td> __Equipment__
 ![Equipment icon](/files/posts/How-much-does-it-cost-icon-equipment.png "Equipment icon")
</td>
 <td> **Labor**
  ![Labor icon](/files/posts/How-much-does-it-cost-icon-labor.png "Labor icon")
</td>
 <td> **Bandwidth**
  ![Bandwidth icon](/files/posts/How-much-does-it-cost-icon-bandwidth.png "Bandwidth icon")
</td>
 </tr>
</table>
...
<table>
 <tr>
 <td> ![Building with equipment](/files/posts/How-much-does-it-cost-building-equipment.png "Building equipment diagram")
 </td>
 <td>
...
* [Gather Tools and Wireless Equipment](http://commotionwireless.net/docs/cck/building-mounting/gather-tools-and-wireless-equipment)

* [Learn About Rooftop Mounts](http://commotionwireless.net/docs/cck/building-mounting/learn-about-rooftop-mounts)
...
1. Ethernet icon designed by Lemon Liu from the Noun Project.
2. Building and equipment diagram by the Work Department.